...
""")
print("""\x1b[32m
    Coded By hama_software
    1877 & 1337 & KURD-H
""")
time.sleep(3)
print("\x1b[32m1: Find admin panel")
print("\x1b[32m2: Find Shell")
x = input(">>> ")
...
'adm/index.brf','adm.brf','affiliate.brf','adm_auth.brf','memberadmin.brf','administratorlogin.brf','cpanel','cpanel.php','cpanel.html']
    ...
    print("\x1b[32m// Example: https://www.google.com")
    url =  input("\x1b[32mEnter Site >>> ")
    lists = ['ALFA.php','wso.php','Wso.php','c99','wso2018.php','alfa.php','1337w0rm.php','r57.php','1.php','2.php','3.php','4.php','Alfa.php','CGI.pl','K2ll33d','adminer.php','cwo.pl','3turr.php','Indoxploit.php','shell.php','Hack.php',"k2.php",'cmd.php','config.php','cgi.root','page.php','1337.php','hacker.php','root.php','kurd.php','erbil.php']
    for i in lists:
        Nurl = url+"/"+i
        try:
